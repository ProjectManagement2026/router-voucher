...
# I HAVE ADDED CUSTOM CSS HERE TO CREATE THE COFFEE SHOP THEME
    ...
    echo "<!DOCTYPE html>
        ...
        <style>
            body {
                background-color: #f4ece4; /* Creamy latte background */
            ...
            .insert {
                ...
                border-radius: 8px;
                box-shadow: 0 4px 15px rgba(75, 54, 33, 0.15);
                max-width: 450px;
                width: 100%;
                padding: 40px;
                text-align: center;
            ...
            /* Create a coffee cup styling for the top header */
            h1, h2 {
                color: #6f4e37;
                font-weight: normal;
                margin-top: 0;
        ...
        <title>$gatewayname - Guest WiFi</title>
        </head>
        <body>
        <div class=\"offset\">
        <div class=\"insert\">
...
footer() {
    ...
    echo "
        <hr>
        <div style=\"font-size:0.7em; color: #8c7b70;\">
            <br>
            &copy; The Daily Grind Café $year<br>
            Powered by openNDS v$version
            <br><br>
        </div>
        </div>
        </div>
...
voucher_validation() {
    ...
    if [ $? -eq 0 ]; then
        ...
        auth_success="
            ...
            <p>
                Enjoy your coffee and your connection.
            </p>
            <hr>
            This voucher is valid for <b>$sessiontimeout minutes</b>.
            <br><br>
            <p class='fine-print'>
                You can now use your browser and apps normally.
            </p>
            <p>
                Your device originally requested <b>$originurl</b>
            </p>
            <form>
                <input type=\"button\" VALUE=\"Start Browsing\" onClick=\"location.href='$originurl'\" >
            </form>
            <hr>
        "
        auth_fail="
            ...
            <hr>
            <p>
                Your login attempt probably timed out or the voucher was invalid.
            </p>
            <p>
                <br>
                Please try again.
        ...
        echo "<div class='alert-fail'>Invalid Voucher</div><br>"
        echo "<p>Please check your receipt and try again.</p>"
        echo "
            <form>
                <input type=\"button\" VALUE=\"Try Again\" onClick=\"location.href='$originurl'\" >
            </form>
...
voucher_form() {
    ...
    echo "
        ...
        <p class='fine-print'>Sip. Relax. Connect.</p>
        <hr>
        ...
        <form action=\"/opennds_preauth/\" method=\"get\">
            ...
            <label style='font-weight:bold;'>Enter Voucher Code:</label><br>
            <input type=\"text\" name=\"voucher\" value=\"$voucher_code\" placeholder=\"e.g. A1B2-C3D4\" required><br>
...
read_terms() {
    ...
    echo "
        <form action=\"/opennds_preauth/\" method=\"get\">
            ...
            <input type=\"submit\" value=\"Read Terms of Service\" style=\"background-color:#dcc0aa; color:#4b3621; font-size:0.8em; padding:8px 16px;\">
        </form>
    "
}
...
display_terms() {
    ...
    #Privacy
    echo "
        <h3 style=\"color:#6f4e37;\">Privacy Policy</h3>
    ...
    # Terms of Service
    echo "
        <h3 style=\"color:#6f4e37;\">Terms of Service</h3>
